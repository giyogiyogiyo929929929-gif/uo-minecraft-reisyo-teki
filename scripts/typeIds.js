// typeIds.js
// バニラのアイテム/ブロックの typeId を、チェストUI(chestForms.js)がアイテムアイコンを
// 描画するために使う内部の数値IDへ変換するための対応表。この数値IDは、テストUI用の
// リソースパック(development_resource_packs/testapia_ui)側のUI定義が、通常のインベントリ
// 描画と同じ仕組みでアイテムのアイコンをレンダリングするために使う。値そのものに手を加える
// 必要は無いデータテーブルのため、そのまま持ち込んでいる。
//
// 出典: Chest-UI (https://github.com/Herobrine643928/Chest-UI) — Herobrine64#3928, LeGend077
// ライセンス: CC BY 4.0 (https://creativecommons.org/licenses/by/4.0/)。詳細は
// development_resource_packs/testapia_ui/CREDITS.md を参照。
